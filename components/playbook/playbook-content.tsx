  ...
  return (
    <LayoutWrapper>
      <div>
        ...
        <p className="text-muted-foreground mt-1">Gerencie as regras de análise da IA e sua biblioteca de modelos</p>
      </div>

      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-3 lg:w-auto">
          <TabsTrigger value="rules">Regras de Análise</TabsTrigger>
