...
const values = [
	{
		...
		title: "Inovação",
		description:
			"Buscamos constantemente novas formas de usar tecnologia para simplificar o trabalho jurídico.",
	},
	{
		icon: Heart,
		title: "Compromisso",
		description:
			"Tratamos cada contrato dos nossos clientes com o mesmo cuidado que trataríamos os nossos.",
	},
	{
		icon: Eye,
		title: "Transparência",
		description:
			"Acreditamos em comunicação clara e honesta com nossos clientes e parceiros.",
	},
	{
		icon: Users,
		title: "Colaboração",
		description:
			"Trabalhamos lado a lado com advogados para criar a melhor ferramenta possível.",
	},
]
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="text-center mb-20">
						...
						<p className="text-xl text-gray-400 max-w-3xl mx-auto">
							Nascemos da frustração de advogados que perdiam horas analisando
							contratos manualmente. Nossa missão é devolver tempo para que
							profissionais do direito foquem no que realmente importa.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-2 gap-12 items-center mb-20">
						<div>
							...
							<div className="space-y-4 text-gray-400">
								<p>
									A Clausify nasceu em 2022, quando dois advogados e um engenheiro
									de software se uniram com um objetivo comum: revolucionar a forma
									como contratos são analisados no Brasil.
								</p>
								<p>
									Frustrados com o tempo gasto em análises manuais e a quantidade
									de riscos que passavam despercebidos, desenvolvemos uma
									inteligência artificial capaz de identificar problemas em
									contratos com precisão superior a 95%.
								</p>
								<p>
									Hoje, mais de 2000 escritórios e departamentos jurídicos confiam
									na Clausify para analisar milhares de contratos todos os meses,
									economizando tempo e reduzindo riscos.
								</p>
							</div>
						</div>
