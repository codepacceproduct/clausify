...
const integrations = [
  {
    ...
    description: "Importe contratos diretamente do Google Drive e salve análises automaticamente.",
    logo: "🟡",
    features: ["Importação automática", "Sincronização bidirecional", "Backup automático"],
  },
  {
    name: "Dropbox",
    category: "Armazenamento",
  ...
  },
  {
    ...
    category: "Calendário",
    description: "Sincronize prazos e obrigações contratuais com seu Google Calendar.",
    logo: "📅",
  ...
  },
  {
    ...
    category: "Calendário",
    description: "Integração nativa com calendário do Outlook para empresas Microsoft.",
    logo: "📆",
  ...
  },
  {
    ...
    description: "Receba notificações sobre contratos diretamente no Slack do seu time.",
    logo: "💬",
  ...
  },
  {
    ...
    category: "Comunicação",
    description: "Integração completa com Teams para colaboração em contratos.",
    logo: "👥",
...
const categories = ["Todos", "Armazenamento", "Calendário", "Comunicação", "Automação", "Desenvolvimento", "ERP", "CRM"]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              A Clausify se integra com mais de 20 ferramentas para automatizar seu fluxo de trabalho jurídico.
            </p>
          </div>
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-emerald-400">{integration.category}</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-20 text-center p-12 bg-gradient-to-b from-emerald-500/10 to-transparent border border-emerald-500/20 rounded-3xl">
            <h2 className="text-3xl font-bold mb-4">Não encontrou sua integração?</h2>
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              Use nossa API REST para criar integrações customizadas ou entre em contato para sugerirmos novas
              integrações.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/api-docs">
                <Button className="bg-emerald-500 hover:bg-emerald-600">Ver Documentação da API</Button>
              </Link>
              <Link href="/contato">
